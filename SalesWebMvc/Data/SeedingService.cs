...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            // Se já existir algo na minha base de dados
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@brown.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@green.com", new DateTime(1979, 12, 31), 1000.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@grey.com", new DateTime(1988, 1, 15), 1000.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@red.com", new DateTime(1993, 11, 30), 1000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@blue.com", new DateTime(2000, 1, 9), 1000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alex@pink.com", new DateTime(1997, 3, 4), 1000.0, d2);
